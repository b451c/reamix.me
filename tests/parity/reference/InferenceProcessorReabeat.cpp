// Copy of references/reabeat-template/src/InferenceProcessor.cpp with class
// renamed to InferenceProcessorReabeat. Do not edit — if REABeat's reference
// changes, re-copy and re-apply the rename.
#if REABEAT_HAS_ONNX
...
InferenceProcessorReabeat::InferenceProcessorReabeat(Ort::Session& session)
    : session_(session) {}
...
InferenceProcessorReabeat::SplitResult InferenceProcessorReabeat::splitPiece(
...
InferenceProcessorReabeat::runInference(const std::vector<std::vector<float>>& chunk)
{
...
std::pair<std::vector<float>, std::vector<float>>
InferenceProcessorReabeat::aggregate(
...
std::pair<std::vector<float>, std::vector<float>>
InferenceProcessorReabeat::process(const std::vector<std::vector<float>>& spectrogram,
