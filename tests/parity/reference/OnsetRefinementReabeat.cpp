// Copy of references/reabeat-template/src/OnsetRefinement.cpp with class renamed
// to OnsetRefinementReabeat. Do not edit.
...
std::vector<float> OnsetRefinementReabeat::detectOnsets(const std::vector<float>& audio,
                                                  int sampleRate)
{
...
std::vector<float> OnsetRefinementReabeat::refine(const std::vector<float>& audio,
                                            int sampleRate,
