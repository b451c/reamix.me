// Copy of references/reabeat-template/src/TimeSigDetector.cpp with class renamed
// to TimeSigDetectorReabeat. Do not edit — re-copy + rename on upstream change.
#include "TimeSigDetectorReabeat.h"
#include <unordered_map>
#include <algorithm>

int TimeSigDetectorReabeat::detect(const std::vector<float>& beats,
